...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li><a href="#" class="active">Parcelle</a></li>
            ...
            <div class="col-md-5"  id="formulaire">
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                        <p>Surface</p>
                        <input type="number" class="form-control" id="inputEmail3" placeholder="surface">
                        </div>
                    </div>
                    <div class="form-group">
                        <!-- <label for="inputPassword3" class="col-sm-2 control-label">Password</label> -->
                        <div class="col-sm-8">
                        <p>Variété de thé planté</p>
                        <select class="form-control" name="idVariete">
                            <option value="">Variété 1</option>
                            <option value="">Variété 2</option>
                            <option value="">Variété 3</option>
                        </select>                
                        </div>
                    </div>
                    <div class="form-group">
